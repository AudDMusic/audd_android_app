...
public class NotificationCenter {
    ...
    public static final int resultAPI = 0;
    public static final int itunesLoaded = 1;
    public static final int searchLoaded = 2;
    public static final int storyLoaded = 3;
    public static final int storyUpdate = 4;
